...
const Forms = () => {
    ...
    {({
      ...
      <Form style={{
        ...
        <Field type="text" name="price"  style={fieldStyle}/>

        <Label htmlFor="stock">Stock</Label>
        <Field type="text" name="stock"  style={fieldStyle}/>

        <Label htmlFor="date">Date</Label>
        <Field type="text" name="date"  style={fieldStyle}/>

        <Label htmlFor="category">Category</Label>
        <Field type="text" name="category"  style={fieldStyle}/>

        <Label htmlFor="description">Description</Label>
        <Field type="text" name="description"  style={fieldStyle}/>
